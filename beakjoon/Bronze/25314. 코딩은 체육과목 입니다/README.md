...
| --- | --- | --- | --- | --- | --- |
| 0.5 초 (추가 시간 없음) | 1024 MB (추가 메모리 없음) | 82868 | 52675 | 47735 | 64.333% |

## 문제

![image](https://github.com/wkdtjdwns/Java/assets/128266768/db3a1e8a-667c-497d-a984-ce1ef984a05a)
...
첫 번째 줄에는 문제의 정수 N이 주어진다. (4 ≤ 𝑁 ≤ 1000; N은 4의 배수)
